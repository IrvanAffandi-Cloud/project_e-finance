...
export default function Home() {
  ...
  // WARNA ELEGAN, TIDAK MENCOLOK (DARK SLATE THEME)
  const menus = [
    ...
    { id: 'PEMASUKAN', path: '/pemasukan', label: 'Pemasukan', colorBg: 'bg-[#1E293B]', colorBorder: 'border-slate-700', colorGlow: 'bg-slate-500/20' },
    { id: 'PENGELUARAN', path: '/pengeluaran', label: 'Pengeluaran', colorBg: 'bg-[#334155]', colorBorder: 'border-slate-600', colorGlow: 'bg-slate-500/20' },
  ]
    ...
    <main className="min-h-screen bg-[#FBFBFD] text-[#1D1D1F] flex flex-col items-center relative overflow-x-hidden font-sans selection:bg-blue-100">
      ...
      <header className="w-full relative z-20 flex justify-center">
        ...
        <div className="relative z-30 flex flex-col items-center justify-center h-[120px] pt-2">
          {/* JUDUL 17px (LEBIH BESAR 1px DARI RUNNING TEXT) */}
      ...
      <div className="flex-1 w-full max-w-[420px] flex flex-col items-center justify-start gap-6 px-8 pt-8 pb-6 relative z-10">
        ...
        {/* AREA TOMBOL YANG LEBIH RAPAT & RATA KIRI */}
        <div className="w-full flex flex-col gap-2 mt-auto">
          ...
          {/* TOMBOL KATEGORI DAN KUNCI (DI BAWAH PENGELUARAN, KECIL, WARNA SAMA) */}
          {isLoggedIn && (
